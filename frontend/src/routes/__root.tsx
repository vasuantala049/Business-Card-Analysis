...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cardfile — business card scanner" },
      {
        name: "description",
        content: "Scan business cards, correct the extracted details, and file them in a searchable index.",
      },
      { property: "og:title", content: "Cardfile — business card scanner" },
      {
          ...
          <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-3">
            ...
            <nav className="flex items-center gap-1 text-sm">
              <Link
                ...
                activeProps={{ className: "bg-accent text-brass" }}
